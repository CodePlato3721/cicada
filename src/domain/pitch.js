...
function estimateFramePitchHz(frame) {
  let mean = 0;
...
// 返回 { gender: 'male' | 'female' | 'unknown', medianHz, voicedFrames }。
export function estimateGender(monoFloat32, thresholdHz = Number(process.env.GENDER_PITCH_THRESHOLD_HZ ?? 165)) {
  const pitches = [];
